...
<p style="margin:10px 0;"><a href="${EWEB_BOOKMARKLET}" onclick="alert('このリンクはブックマークバーへドラッグして登録してください。クリックではこのアプリ上では動作しません。');return false;" class="btn primary" style="text-decoration:none; display:inline-block;">📌 eWeb取込（ブックマークバーへドラッグ）</a></p>
